...
BEGIN
	...
	-- Loading silver.cbs_accounts
    SET @start_time = GETDATE();
	PRINT '>> Truncating Table: silver.cbs_accounts';
	TRUNCATE TABLE silver.cbs_accounts
	PRINT '>> Inserting Data Into : silver.cbs_accounts';
	...
	-- Loading silver.cbs_products
	SET @start_time = GETDATE();
	PRINT '>> Truncating Table: silver.cbs_products';
	TRUNCATE TABLE silver.cbs_products
	PRINT '>> Inserting Data Into : silver.cbs_products';
	...
	-- Loading silver.cbs_transactions
	SET @start_time = GETDATE();
	PRINT '>> Truncating Table: ssilver.cbs_transactions';
	TRUNCATE TABLE silver.cbs_transactions
	PRINT '>> Inserting Data Into : silver.cbs_transactions';
	...
	-- Loading silver.erp_branches

	SET @start_time = GETDATE();
	PRINT '>> Truncating Table: silver.erp_branches';
	TRUNCATE TABLE silver.erp_branches
	PRINT '>> Inserting Data Into : silver.erp_branches'
